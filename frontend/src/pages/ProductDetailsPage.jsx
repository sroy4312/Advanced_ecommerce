            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                    ...
                    <p className="ml-3 text-sm font-semibold text-indigo-600 hover:text-indigo-500">3870 reviews</p>
                </div>
              </div>
              ...
              <form className="mt-10">
                ...
                <div className="mt-5">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-4 gap-4 sm:grid-cols-12 lg:grid-cols-10">
                ...
                <Button onClick={handleAddToCart} variant="contained" sx={{px: "2rem", py: "1rem", bgcolor: "#9155FD", mt: "1.3rem"}}>
                  Add to Cart
                </Button>
              </form>
            </div>
              ...
              <Grid item xs={5}>
                ...
                <Box className="mt-5 space-y-3">
                  ...
                  <Grid container alignItems={"center"} gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress variant="determinate" value={25} color="secondary" sx={{bgcolor: "#D0D0D0", borderRadius: 4, height: 7}} />
                    </Grid>
                  </Grid>
                  <Grid container alignItems={"center"} gap={2}>
                    <Grid item xs={2}>
